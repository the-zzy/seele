...
CREATE TABLE IF NOT EXISTS portfolio_daily_position (
    ...
    avg_cost DECIMAL(18,4) NOT NULL DEFAULT 0 COMMENT '平均成本',
    close_price DECIMAL(18,4) COMMENT '当日收盘价',
    market_value DECIMAL(18,4) DEFAULT 0 COMMENT '当日市值',
    day_buy DECIMAL(18,4) DEFAULT 0 COMMENT '当日买入金额',
    day_sell DECIMAL(18,4) DEFAULT 0 COMMENT '当日卖出金额',
    unrealized_pnl DECIMAL(18,4) DEFAULT 0 COMMENT '当日浮动盈亏',
...
CREATE TABLE IF NOT EXISTS portfolio_daily_summary (
    id INT AUTO_INCREMENT PRIMARY KEY COMMENT '主键',
    trade_date DATE NOT NULL COMMENT '交易日期',
    total_invested DECIMAL(18,4) DEFAULT 0 COMMENT '总投入成本',
    total_market_value DECIMAL(18,4) DEFAULT 0 COMMENT '当日收盘总市值',
    ...
    unrealized_pnl DECIMAL(18,4) DEFAULT 0 COMMENT '浮动盈亏',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
